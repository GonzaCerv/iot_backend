...
For example if you see in your "iot_web/settings.py" a variable named like
`random_parameter`, you should provide the "IOT_WEB_RANDOM_PARAMETER"
variable to configure the value. This behaviour can be changed by overriding `env_prefix` property
in `iot_web.settings.Settings.Config`.
